...
def _worker(args: dict):
    ...
    if args["benchmark"]:
        ...
        json_writer.add_field("copy_engine_tflops", tflops)
        json_writer.add_field("copy_engine_bandwidth_gbps", bandwidth_gbps)
        json_writer.add_field("copy_engine_total_ms", triton_ms)
