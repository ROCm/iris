...
"""
Tune ``m_tiles_per_batch`` for ``matmul_all_gather_copy_engine``.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Tune m_tiles_per_batch for matmul_all_gather_copy_engine.",
...
def main():
    ...
    if args.output_dir:
        ...
        output_dir = Path(f"benchmark/ops/matmul_all_gather/{output_stem}_{ts}")
