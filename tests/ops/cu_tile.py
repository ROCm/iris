...
for M in [2048]:
    ...
    P(f"{'BM':>4} {'BN':>4} {'WG':>5} {'ms':>9} {'GB/s':>9} {'% of 448':>9} {'vs 256WG':>9}")
    base=None
    for BM,BN,wg in [(32,128,64),(32,128,128),(64,128,64),(64,128,128),(128,64,128),(128,64,256),(128,128,128),(128,128,256),(256,128,128),(64,256,128),(128,256,128),(256,256,64)]:
        shmem.barrier()
        ...
        P(f'{BM:>4} {BN:>4} {wg:>5} {ms:>9.4f} {gb:>9.1f} {gb/448*100:>8.0f}% {(base/ms if base else float("nan")):>8.2f}x')
