...
class Config:
    ...
    def __post_init__(self):
        ...
        if self.all_gather_variant not in ["persistent", "partitioned", "hoisted"]:
            raise ValueError(
                f"all_gather_variant must be one of: 'persistent', 'partitioned', 'hoisted', got {self.all_gather_variant}"
            )
