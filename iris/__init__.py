...
- iris_gluon: Gluon-based implementation with @aggregate backend
...
# Import Gluon-based implementation (optional, for users who want the aggregate API)
...
__all__ = [
    ...
    "do_bench",
    "hip",
    "iris_gluon",  # Gluon-based implementation
    "set_logger_level",
    "logger",
    "DEBUG",
    "INFO",
