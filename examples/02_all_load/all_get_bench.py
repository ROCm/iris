...
def all_read_kernel(
    ...
    if world_size == 1:
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 0, heap_bases_ptr, mask=mask)
    elif world_size == 2:
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 0, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 1, heap_bases_ptr, mask=mask)
    elif world_size == 4:
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 0, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 1, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 2, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 3, heap_bases_ptr, mask=mask)
    else:
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 0, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 1, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 2, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 3, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 4, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 5, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 6, heap_bases_ptr, mask=mask)
        iris.get(source_buffer + offsets, target_buffer + offsets, cur_rank, 7, heap_bases_ptr, mask=mask)
