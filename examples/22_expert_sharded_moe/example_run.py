...
Usage:
    torchrun --nproc_per_node=2 example_run.py
    torchrun --nproc_per_node=2 example_run.py --n_tokens 128 --d_model 64
"""
...
def parse_args():
    ...
    parser.add_argument("--num_ranks", type=int, default=None, help="Ignored (use torchrun --nproc_per_node instead)")
