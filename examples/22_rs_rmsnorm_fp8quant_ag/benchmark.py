...
def _worker(local_rank: int, world_size: int, init_url: str, args: dict):
    ...
    # Use gloo backend to avoid below warning for now
    #    backend = "nccl" if torch.cuda.is_available() else "gloo"
    # /opt/venv/lib/python3.10/site-packages/torch/distributed/distributed_c10d.py:4814:
    # UserWarning: No device id is provided via `init_process_group` or `barrier
